...
public class CodeGeneration {
    public static void main(String[] args) {
        ...
        DataSourceConfig dsc = new DataSourceConfig.Builder("jdbc:mysql://localhost:3306/mqq?&useSSL=true&useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai","root","123456")
        ...
        PackageConfig packages = new PackageConfig.Builder()
                .entity("entity")//实体类包名
                .parent("com.example.mqq")//父包名。如果为空，将下面子包名必须写全部， 否则就只需写子包名
...
//            .build();
        ...
        StrategyConfig strategyConfig = new StrategyConfig.Builder()
                ...
                //.likeTable()模糊表匹配
                .addInclude(table)//添加表匹配，指定要生成的数据表名，不写默认选定数据库所有表
